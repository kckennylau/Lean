import algebra.module order.lattice
...
instance is_linear_map.to_is_add_group_hom {α : Type*} {β : Type*} {γ : Type*}
  [ring α] [module α β] [module α γ]
  (f : β → γ) (hf : is_linear_map f) : is_add_group_hom f :=
⟨λ _ _, is_linear_map.add hf _ _⟩
